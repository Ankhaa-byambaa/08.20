  ...
  return (
    <>
      <div className="bg-white w-[377px] h-[290px] rounded-[6px] flex flex-col gap-10 pt-6 pb-6 pl-4 pr-4 ">
        <div>
          <p className="text-black font-sans text-[20px] flex justify-center items-center">
            To-Do list
          </p>
          <div>
            <input className="border-[1px] border-neutral-200 rounded-[6px] w-[280px] h-[40px] "></input>
            <ButtonBlue name="add"></ButtonBlue>
          </div>
          <Button name="Active"></Button>
          <Button name="Completed"></Button>
          <ButtonBlue name="all"></ButtonBlue>
